...
description: |
  Outline of a Course in Data Analysis using R and the Tidyverse suite of tools.
author:
- name: Kieran Healy
...
- Begin by installing R (<http://cloud.r-project.org>). Choose the version appropriate for your computing platform: [macOS](https://cloud.r-project.org/bin/macosx/R-4.0.3.pkg), [Windows](https://cloud.r-project.org/bin/windows/base/R-4.0.3-win.exe), or [Linux](https://cloud.r-project.org/bin/linux/).
