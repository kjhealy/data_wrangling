...
## ----07-itrerating-on-census-5, message=FALSE, results='hide'----------------------------------------------------------------------------------------------
df <- 2005:2019 %>% 
...
## ----07-itrerating-on-census-6, message=FALSE, results='hide'----------------------------------------------------------------------------------------------
df <- 2005:2019 %>% 
  set_names() %>% 
  map_dfr(~ get_acs(geography = "county", 
                    variables = "B19013_001",
...
## ----07-itrerating-on-census-7, message=FALSE, results='hide', fig.width=8, fig.height=4-------------------------------------------------------------------
2005:2019 %>% 
  set_names() %>% 
