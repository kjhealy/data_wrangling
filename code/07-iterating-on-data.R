...
## ----07-iterating-on-census-2, message=FALSE, results='hide'------------------------------------------------------------------------------
out <- get_acs(geography = "county", 
                    variables = "B19013_001",
                    state = "NY", 
                    survey = "acs1",
...
## ---- 07-iterating-on-census-4------------------------------------------------------------------------------------------------------------
c(1:10) %>% 
  set_names()



## ----07-iterating-on-census-5, message=FALSE, results='hide'------------------------------------------------------------------------------
df <- 2005:2019 %>% 
...
## ----07-iterating-on-census-6, message=FALSE, results='hide'------------------------------------------------------------------------------
df <- 2005:2019 %>% 
  set_names() %>% 
  map_dfr(~ get_acs(geography = "county", 
                    variables = "B19013_001",
...
## ----07-iterating-on-census-7, message=FALSE, results='hide'------------------------------------------------------------------------------
p_out <- 2005:2019 %>% 
  set_names() %>% 
...
## ----07-iterating-on-census-7a, fig.width=12, fig.height=5--------------------------------------------------------------------------------
print(p_out)
...
## ----07-iterating-on-data-21--------------------------------------------------------------------------------------------------------------
sessions



## ----07-iterating-on-data-22, message = TRUE----------------------------------------------------------------------------------------------
...
## ----07-iterating-on-data-25--------------------------------------------------------------------------------------------------------------
# Nope
df %>% 
  filter(age == NA)


## ----07-iterating-on-data-26--------------------------------------------------------------------------------------------------------------
# E.g.
23 == NA


## ----07-iterating-on-data-27--------------------------------------------------------------------------------------------------------------
# Yes
df %>% 
  filter(is.na(age))
...
## ----07-iterating-on-data-29, fig.height=6, fig.width=8-----------------------------------------------------------------------------------
gg_miss_var(organdata)


## ----07-iterating-on-data-30, fig.height=6, fig.width=8-----------------------------------------------------------------------------------
vis_dat(organdata)


## ----07-iterating-on-data-31, fig.height=6, fig.width=8-----------------------------------------------------------------------------------
miss_var_summary(organdata)


## ----07-iterating-on-data-32--------------------------------------------------------------------------------------------------------------
...
## ----07-iterating-on-data-34, fig.height=6, fig.width=8-----------------------------------------------------------------------------------
vis_miss(organdata)


## ----07-iterating-on-data-35, fig.height=6, fig.width=8-----------------------------------------------------------------------------------
library(congress)
gg_miss_upset(congress)


## ----07-iterating-on-data-36, fig.height=6, fig.width=8-----------------------------------------------------------------------------------
vis_miss(organdata, cluster = TRUE)


## ----07-iterating-on-data-37, fig.height=6, fig.width=8-----------------------------------------------------------------------------------
gg_miss_upset(organdata)


## ----07-iterating-on-data-38--------------------------------------------------------------------------------------------------------------
...
## ----07-iterating-on-data-43, fig.width=16, fig.height=9, eval = FALSE--------------------------------------------------------------------
...
## ----07-iterating-on-data-44, fig.width=12, fig.height=7, echo = FALSE--------------------------------------------------------------------
# devtools::install_github("krassowski/complex-upset")
