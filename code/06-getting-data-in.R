## ----06-getting-data-in-1, include=FALSE--------------------------------------------------------------------------------------------------
library(flipbookr)
library(here)
library(tidyverse)
library(kjhslides)
...
## ----06-getting-data-in-2, message = TRUE-------------------------------------------------------------------------------------------------
...
## ----06-getting-data-in-3-----------------------------------------------------------------------------------------------------------------
here() # this path will be different for you


## ----06-getting-data-in-4, echo = FALSE---------------------------------------------------------------------------------------------------
...
## ----06-getting-data-in-10, message=TRUE--------------------------------------------------------------------------------------------------
engmort <- read_table(here("data", "mortality.txt"), 
                      skip = 2, na = ".")



## ----06-getting-data-in-11, include = FALSE-----------------------------------------------------------------------------------------------
...
## ----06-getting-data-in-12, warning = TRUE------------------------------------------------------------------------------------------------
...
## ----06-getting-data-in-25----------------------------------------------------------------------------------------------------------------
# This is not a tibble; we have to index it the basic way
raw_file[2753:2758] 


## ----06-getting-data-in-26, message = TRUE------------------------------------------------------------------------------------------------
nchs <- with_edition(1, read_csv(here("data", "SAS_on_2021-04-13.csv"))) 
...
## ----06-getting-data-in-29----------------------------------------------------------------------------------------------------------------
nchs %>% 
  distinct(year) #<<



## ----06-getting-data-in-30, echo = FALSE--------------------------------------------------------------------------------------------------
nchs_fmt <- nchs %>% 
  select(-year, -month) %>% 
...
## ----06-getting-data-in-31, include=FALSE-------------------------------------------------------------------------------------------------
...
## ----06-getting-data-in-40, include = FALSE-----------------------------------------------------------------------------------------------
...
## ----06-getting-data-in-61, include = FALSE-----------------------------------------------------------------------------------------------
gss_sub %>%
    mutate(agequint = cut(x = age, 
                          breaks = unique(age_quintiles), 
                          include.lowest = TRUE)) %>% 
...
## ----06-getting-data-in-74----------------------------------------------------------------------------------------------------------------
summary(lm(age ~ sex, data = gss_sub))


## ----06-getting-data-in-75----------------------------------------------------------------------------------------------------------------
gss_sub <- gss_sub %>% 
...
## ----06-getting-data-in-76----------------------------------------------------------------------------------------------------------------
gss_sub %>% 
  mutate(degree_n = fct_lump_n(degree, n = 3)) %>% 
  count(degree_n)


## ----06-getting-data-in-77----------------------------------------------------------------------------------------------------------------
gss_sub %>% 
