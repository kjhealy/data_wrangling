## ----03a-dplyr-basics-1, include=FALSE----------------------------------------------------------------------------------------------------
library(flipbookr)
library(here)
library(tidyverse)
library(kjhslides)
...
## ----03a-dplyr-basics-2, message = TRUE---------------------------------------------------------------------------------------------------
...
## ----03a-dplyr-basics-6, include = FALSE--------------------------------------------------------------------------------------------------
gss_sm %>% 
  group_by(bigregion) %>% 
  summarize(total = n())


## ----03a-dplyr-basics-7, include = FALSE--------------------------------------------------------------------------------------------------
gss_sm %>% 
  group_by(bigregion, religion) %>% 
  summarize(total = n())


## ----03a-dplyr-basics-8, include = FALSE--------------------------------------------------------------------------------------------------
gss_sm %>% 
  group_by(bigregion, religion) %>% 
  summarize(total = n()) %>% 
...
## ----03a-dplyr-basics-15, eval = FALSE----------------------------------------------------------------------------------------------------
## gss_sm %>%
##   count(bigregion, religion) %>%
...
## ----03a-dplyr-basics-16, echo = FALSE----------------------------------------------------------------------------------------------------
gss_sm %>% 
  count(bigregion, religion) %>% 
  pivot_wider(names_from = bigregion, values_from = n) %>% 
  kable()  
...
## ----03a-dplyr-basics-17, fig.height=4, fig.width=15--------------------------------------------------------------------------------------
gss_sm %>% 
  group_by(bigregion, religion) %>% 
  tally() %>% 
...
## ----03a-dplyr-basics-28, echo = FALSE----------------------------------------------------------------------------------------------------
#theme_set(cowplot::theme_minimal_grid())


## ----03a-dplyr-basics-29, fig.height = 4, fig.width=10------------------------------------------------------------------------------------
gss_sm %>% 
...
## ----03a-dplyr-basics-30, include = FALSE-------------------------------------------------------------------------------------------------
gss_sm %>% 
  group_by(race, sex, degree) %>% 
  summarize(n = n(), 
            mean_age = mean(age, na.rm = TRUE), 
