...
- Pipelines feed their content forward, so you need to make sure your results are not all wrong.
...
`r chunk_reveal("03-kid-pipeline", widths = c(25,75), title = "Following a pipeline")`
