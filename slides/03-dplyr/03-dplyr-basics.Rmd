...
.pull-left[![:scale 44% "RMD out"](img/02/knit-rmd-tall.png)]  
...
- ![:scale 80% "Conflicts"](img/02/function-masking.png)
...
[![:scale 80% "Vectors 1"](img/02/summary-tree-atomic.png)]  
...
[![:scale 90% "Vectors 2"](img/02/summary-tree-s3.png)]  
