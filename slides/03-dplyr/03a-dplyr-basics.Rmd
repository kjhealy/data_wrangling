...
`r chunk_reveal("03-dplyr-twocol-summary", widths = c(40,55), title = "# Group and summarize by .kjh-orange[_two_] columns")`
...
`r chunk_reveal("03-dplyr-freq", widths = c(40,60), title = "# Calculate frequencies")`
...
- .kjh-green[**`list()`**] of the form `result = function` gives the new columns that will be calculated.
