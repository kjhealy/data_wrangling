...
```{r 05-regular-expressions-1, include=FALSE}
library(flipbookr)
library(here)
library(tidyverse)
library(kjhslides)
...
.SMALL[
```{r 05-regular-expressions-2, message = FALSE}
...
```{r 05-regular-expressions-3, message = TRUE}
...
`r chunk_reveal("05-regular-expressions-25", widths = c(60,40), title = "# Example: Politics and Placenames")`


```{r 05-regular-expressions-25, include=FALSE}
...
```{r 05-regular-expressions-27, include=FALSE}
place_tab %>% 
...
`r chunk_reveal("05-regular-expressions-27", widths = c(45,55), title = "# Example: Politics and Placenames")`
