...
# Piped operations make code more .kjh-green[readable]
...
It will be denoted by **`|>`**. But! It will not _quite_ replace **`%>%`** in every case.\* 
...
# 5. Objects come in ,kjh-yellow[types and classes]
