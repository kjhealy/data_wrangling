...
- I'm going to use .kjh-pink[**`<-`**] for assigment throughout. 
...
- The pipe operator .kjh-green[**`%>%`**] is not part of Base R. It was introduced in a package called `magrittr`. 
...
- It is denoted by .kjh-green[**`|>`**]. Type .kjh-green[**`|`**] and then .kjh-green[**`>`**] to write it. It mostly but does not _quite_ replace .kjh-green[**`%>%`**] in every case.\* 
