...
:::{.huge}
 Using Quarto to [produce]{.fg-orange} and [reproduce]{.fg-green} your work 
:::
...
![PDF out](img/lorem-covid-latex.png){fig-align="center" width=90%}  

---

## Where we want to end up

![HTML out](img/lorem-covid-html.png){fig-align="center" width=45%}  
...
![Word out](img/lorem-covid-word.png){fig-align="center" width=100%}  
...
:::: {.columns}
::: {.column width="50%"}
  ![](img/covid-r-script.png){fig-align="center"} 
:::
...
![](img/lorem-covid-markdown.png){fig-align="center" width=90%}  

---

![](img/lorem-covid-markdown-annotated.png){fig-align="center" width=90%}  

---

:::: {.columns}
::: {.column width="60%"}
![](img/lorem-covid-html-full.png){width=70%}    
:::
...
:::: {.columns}
::: {.column width="40%"}
  ![](img/knit-rmd-tall.png){width=70%}
:::
...
::: aside
_By far_ the best way to get a feel for how R works, and to get comfortable with the cycle of try-fail-cry-fix-wail-retry that is a permanent part of writing any code.  
:::

---

![Samuel Beckett](img/beckett-fail-better.png){fig-align="center" width=90%}
...
![](img/function-masking.png){with=90%}
