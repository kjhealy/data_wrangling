...
# .kjh-yellow[read_csv()] can do this directly now

```{r 07-iterating-on-data-16a}
...
# Iterating on the .kjh-yellow[US Census]

- Not just for local files!

```{r 07-itrerating-on-census-1}
...
```{r 07-iterating-on-census-2, message=FALSE, results='hide'}
out <- get_acs(geography = "county", 
                    variables = "B19013_001",
                    state = "NY", 
                    survey = "acs1",
...
```{r 07-itrerating-on-census-5, message=FALSE, results='hide'}
df <- 2005:2019 %>% 
...
```{r 07-itrerating-on-census-6, message=FALSE, results='hide'}
df <- 2005:2019 %>% 
  set_names() %>% 
  map_dfr(~ get_acs(geography = "county", 
                    variables = "B19013_001",
...
# Iterating on the .kjh-yellow[US Census]
```{r 07-itrerating-on-census-7, message=FALSE, results='hide', fig.width=8, fig.height=4}
2005:2019 %>% 
  set_names() %>% 
...
```{r 07-iterating-on-data-22, message = TRUE}
...
```{r 07-iterating-on-data-29, fig.height=6, fig.width=8}
...
```{r 07-iterating-on-data-30, fig.height=6, fig.width=8}
vis_dat(organdata)
```
...
```{r 07-iterating-on-data-31, fig.height=6, fig.width=8}
...
```{r 07-iterating-on-data-34, fig.height=6, fig.width=8}
vis_miss(organdata)
```
...
```{r 07-iterating-on-data-35, fig.height=6, fig.width=8}
library(congress)
...
```{r 07-iterating-on-data-36, fig.height=6, fig.width=8}
...
```{r 07-iterating-on-data-37, fig.height=6, fig.width=8}
...
```{r 07-iterating-on-data-43, fig.width=16, fig.height=9, eval = FALSE}
...
```{r 07-iterating-on-data-44, fig.width=12, fig.height=7, echo = FALSE}
# devtools::install_github("krassowski/complex-upset")
