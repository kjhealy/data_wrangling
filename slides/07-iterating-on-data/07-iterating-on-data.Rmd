...
output:
  xaringan::moon_reader:
    ...
    css: ["default", "../css/kjh-slides.css", "../css/kjh-inferno-fonts.css", "../css/animate.css", "../css/widths.css", "../css/widths.css"]
    seal: false
...
Speaking loosely, think of .kjh-green[**`map()`**] as a way of .kjh-green[Iterating] without writing loops. You start with a vector of things and you feed it to the function one thing at a time. The function does whatever it does, and you get back output that is the same length as your input.
...
In this context, .kjh-green[**`n_distinct()`**] is always going to return an integer, though.
