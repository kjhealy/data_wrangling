...
# .middle[<br />.kjh-orange[**Data Analysis**]<br />is mostly<br />.kjh-red[**Data Wrangling**]]
...
# We take a broadly _Plain Text_ approach
...
# .middle[Two revolutions in computing]
...
.middle[- I mean, “Making different specialized applications and resources work together in the service of a single but multi-dimensional project”, not “Checking Twitter while also listening to a talk and trying to keep up with the updates from the softball game.”]
...
- Why can't I remember how I made this Figure or Table?

- `Paper_Submission_Final_edits_FINAL_khcomments-1.docx`
...
.center[![:scale 75% "rstudio-3.png"](img/01/rstudio-conceptual-3.png)]
