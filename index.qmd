...
- If you use macOS with an Apple Silicon processor (i.e. and M1 or M2 processor), then install [R for macOS's Apple Silicon build](https://cloud.r-project.org/bin/macosx/big-sur-arm64/base/R-4.3.1-arm64.pkg). This version does not work on older, Intel-based Macs.

- If you use macOS with an Intel processor, then install [R for macOS's Intel build](https://cloud.r-project.org/bin/macosx/big-sur-x86_64/base/R-4.3.1-x86_64.pkg). 

- If you use Microsoft Windows, then install [R for Windows](https://cloud.r-project.org/bin/windows/base/R-4.3.1-win.exe)
...
- If you use macOS (whether Apple Silicon or Intel), [install this version of RStudio](https://download1.rstudio.org/electron/macos/RStudio-2023.09.0-463.dmg)

- If you use Windows, [install this version of RStudio](https://download1.rstudio.org/electron/windows/RStudio-2023.09.0-463.exe)
...
[Download the Data Wrangling Course Packet](https://github.com/kjhealy/data_wrangling/archive/refs/heads/main.zip)
