...
my_packages <- c("tidyverse", "babynames", "broom", "drat", "gapminder",  
                  ...
                  "skimr", "socviz", "usethis", "visdat", "reprex")
...
2. Tabulating and summarizing data with `dplyr`
...
4. Managing textual and categorical data with `stringr` and `forcats`
...
5. Getting data into R and cleaning it
...
6. Iterating on data with `dplyr`, `purrr`, and `broom`
