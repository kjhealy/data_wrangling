...
- If you use macOS with an Apple Silicon processor (i.e. and M1 or M2 processor), then install [R for macOS's Apple Silicon build](https://cloud.r-project.org/bin/macosx/big-sur-arm64/base/R-4.2.2-arm64.pkg). This version does not work on older, Intel-based Macs.
